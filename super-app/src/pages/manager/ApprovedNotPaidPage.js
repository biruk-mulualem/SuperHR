...
// Sample data for Approved Not Paid
const APPROVED_DATA = [
  { 
    id: 4, 
    item: 'Hydraulic Pump', 
...
const ApprovedNotPaidPage = ({ onBack, darkMode, textColor, subTextColor, cardBg, borderColor }) => {
  const [searchQuery, setSearchQuery] = useState('');
  const data = APPROVED_DATA;
  ...
  const renderItem = ({ item }) => (
    ...
    >
      <View style={styles.listItemHeader}>
        ...
        <View style={[styles.listItemStatus, { backgroundColor: '#3B82F620' }]}>
          <Text style={[styles.listItemStatusText, { color: '#3B82F6' }]}>
            APPROVED
          </Text>
        </View>
      </View>
  ...
  return (
    <SafeAreaView style={[styles.detailContainer, { backgroundColor: darkMode ? '#0F172A' : '#F8FAFC' }]}>
      <View style={styles.detailHeader}>
        ...
        <Text style={[styles.detailTitle, { color: textColor }]}>✅ Approved Not Paid</Text>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Text style={[styles.emptyText, { color: subTextColor }]}>No approved items waiting for payment</Text>
          </View>
        }
      />
    </SafeAreaView>
...
export default ApprovedNotPaidPage;