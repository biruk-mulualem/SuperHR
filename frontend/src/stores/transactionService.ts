...
class TransactionService {
     ...
     */
    async getRecentTransactions(limit: number = 10): Promise<{ success: boolean; data: Transaction[] }> {
     ...
     * Get transactions by balance ID
     */
    async getTransactionsByBalance(balanceId: number, page: number = 1, limit: number = 20): Promise<PaginatedResponse<Transaction>> {
