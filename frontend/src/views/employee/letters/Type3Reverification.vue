    ...
    <div v-if="showSettings" class="modal-overlay" @click.self="showSettings = false">
      <div class="modal-container">
        <div class="modal-header">
          <h2>Settings - Guarantee Re-verification Letter</h2>
...
// Document HTML - Guarantee Re-verification Letter
...
const printDocument = () => {
  ...
  printWindow.document.write(`
    ...
    <html>
      <head>
        <title>Guarantee Re-verification Letter</title>
        <style>
