...
/** @type {__VLS_StyleScopedClasses['dropdown-item']} */ ;
/** @type {__VLS_StyleScopedClasses['no-results-item']} */ ;
/** @type {__VLS_StyleScopedClasses['clear-selection-btn']} */ ;
...
/** @type {__VLS_StyleScopedClasses['toast']} */ ;
/** @type {__VLS_StyleScopedClasses['documents-page']} */ ;
...
if (__VLS_ctx.showToolbar) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (...[$event]) => {
                ...
                // @ts-ignore
                [showToolbar, toolbarPosition, toolbarPosition, execCommand,];
            } },
        ...{ class: "toolbar-btn" },
    });
    /** @type {__VLS_StyleScopedClasses['toolbar-btn']} */ ;
...
if (__VLS_ctx.showSettings) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ onClick: (...[$event]) => {
                ...
                // @ts-ignore
                [goBack, openSettings, printDocument, showToolbarAtSelection, showToolbarAtSelection, saveContent, documentHtml, showSettings, showSettings,];
            } },
        ...{ class: "modal-overlay" },
    });
    /** @type {__VLS_StyleScopedClasses['modal-overlay']} */ ;
    ...
    if (__VLS_ctx.showDropdown && __VLS_ctx.filteredEmployees.length === 0 && __VLS_ctx.employeeSearchTerm) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
            ...{ class: "dropdown-item no-results-item" },
        });
        /** @type {__VLS_StyleScopedClasses['dropdown-item']} */ ;
        /** @type {__VLS_StyleScopedClasses['no-results-item']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({});
    ...
    if (__VLS_ctx.selectedEmployee) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
            ...{ class: "selected-employee-display" },
        });
        /** @type {__VLS_StyleScopedClasses['selected-employee-display']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
            ...{ class: "selected-name" },
        });
        /** @type {__VLS_StyleScopedClasses['selected-name']} */ ;
        (__VLS_ctx.selectedEmployee.fullName);
        __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
            ...{ class: "selected-id" },
        });
        /** @type {__VLS_StyleScopedClasses['selected-id']} */ ;
        (__VLS_ctx.selectedEmployee.employeeId);
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (...[$event]) => {
                ...
                __VLS_ctx.showSettings = false;
                // @ts-ignore
                [showSettings, showDropdown, employeeSearchTerm, filteredEmployees, selectedEmployee, selectedEmployee, selectedEmployee, clearSelection, refNumber, letterDate, recipientOrg, refLetterNumber, refLetterDate, guarantorName,];
            } },
        ...{ class: "cancel-btn" },
    });
    /** @type {__VLS_StyleScopedClasses['cancel-btn']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (__VLS_ctx.updateDocument) },
        ...{ class: "save-btn" },
    });
    /** @type {__VLS_StyleScopedClasses['save-btn']} */ ;
}
