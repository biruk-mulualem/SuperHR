    ...
    <div v-if="showSettings" class="modal-overlay" @click.self="showSettings = false">
      <div class="modal-container">
        <div class="modal-header">
          <h2>Settings - Police Station Guarantee Letter</h2>
...
// Document HTML - Police Station Guarantee Letter
...
<div class="letter">
  ...
  <div class="body-text">
    በድርጅታችን ሱፐር ደብል ቲ ጀነራል ትሬዲንግ ኃ.የተ.የግል ማህበር ውስጥ ተቀጥረው እያገለገሉ ለሚገኙት ለአቶ/ወ/ሮ/ወ/ሪት <strong>${employeeName.value || '__________'}</strong> ከአየር ጠፍ ፖሊስ ጣያ በደብዳቤ ቁጥር <strong>${refLetterNumber.value || '__________'}</strong> በቀን <strong>${refLetterDate.value || '__________'}</strong> ዓ.ም በተጻፈ ደብዳቤ አቶ/ወ/ሮ/ወ/ሪት <strong>${guarantorName.value || '__________'}</strong> ዋስትና ገብተዋል። አባሉም በዝውዋር ወደ እናንተ ፖሊስ ጣያ የተዘዋወሩ መሆኑ ተገልጾልናል።
  </div>
  <div class="body-text">
    በዚህም መሰረት ሁሉም መስሪያ ቤቶች በማፅፉልን ደብዳቤ ላይ ዋስትና የገባው ሰራተኛ በተለያየ ምክንያት ስራውን መልቀቅ ሲፈልግ ከመልቀቁ በፊት ለድርጅታችን እንደሚያሳውቁ ይገልጻልናል።
  </div>
  <div class="body-text">
    ሆኖም ግን አንዳንድ መስሪያ ቤቶች ሰራተኛው ሲለቅ በተለያየ ምክንያት አያሳውቁም። በመሆኑም ከላይ የተጠቀሱት የድርጅታችሁ ሰራተኛ በስራ ላይ ስለመኖራቸው በሚመለከተው አካል ፊርማ እና በድርጅቱ ማህተም ታረጋግጡልን ዘንድ በማክበር እንጠይቃለን።
  </div>
...
const printDocument = () => {
  ...
  printWindow.document.write(`
    ...
    <html>
      <head>
        <title>Police Station Guarantee Letter</title>
        <style>
