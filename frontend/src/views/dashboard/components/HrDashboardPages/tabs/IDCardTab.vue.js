...
if (!__VLS_ctx.loading) {
    ...
    (__VLS_ctx.missingPagination.total);
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ class: "table-wrapper" },
    });
    ...
    for (const [emp, idx] of __VLS_vFor((__VLS_ctx.paginatedMissing))) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)({
            key: (emp.id),
            ...{ class: "data-row" },
        });
        ...
        (__VLS_ctx.getMissingRowIndex(idx));
        __VLS_asFunctionalElement1(__VLS_intrinsics.td, __VLS_intrinsics.td)({});
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
            ...{ class: "employee-cell" },
        });
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    // @ts-ignore
                    [debounceSearch, searchQuery, searchQuery, clearSearch, exportToExcel, loading, loading, missingPagination, paginatedMissing, getMissingRowIndex, getAvatarColor, getInitials, goToEdit,];
                } },
            ...{ class: "btn-edit" },
        });
        /** @type {__VLS_StyleScopedClasses['btn-edit']} */ ;
    ...
    if (__VLS_ctx.paginatedMissing.length === 0) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)({});
        __VLS_asFunctionalElement1(__VLS_intrinsics.td, __VLS_intrinsics.td)({
            colspan: "7",
            ...{ class: "empty-state" },
        ...
        (__VLS_ctx.searchQuery ? 'No employees found matching your search' : '✅ All employees have submitted National IDs!');
    }
    if (__VLS_ctx.missingPagination.totalPages > 1) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
            ...{ class: "pagination" },
        });
        /** @type {__VLS_StyleScopedClasses['pagination']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    if (!(__VLS_ctx.missingPagination.totalPages > 1))
                        return;
                    __VLS_ctx.changeMissingPage(__VLS_ctx.missingPagination.page - 1);
                    // @ts-ignore
                    [searchQuery, missingPagination, missingPagination, paginatedMissing, changeMissingPage,];
                } },
            disabled: (!__VLS_ctx.missingPagination.hasPrevPage || __VLS_ctx.loading),
        ...
        for (const [page] of __VLS_vFor((__VLS_ctx.visiblePages))) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
                ...{ onClick: (...[$event]) => {
                        ...
                        if (!(__VLS_ctx.missingPagination.totalPages > 1))
                            return;
                        __VLS_ctx.changeMissingPage(page);
                        // @ts-ignore
                        [loading, missingPagination, changeMissingPage, visiblePages,];
                    } },
                key: (page),
                ...{ class: (['page-btn', { active: page === __VLS_ctx.missingPagination.page }]) },
            });
            /** @type {__VLS_StyleScopedClasses['active']} */ ;
            /** @type {__VLS_StyleScopedClasses['page-btn']} */ ;
            (page);
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    __VLS_ctx.changeMissingPage(__VLS_ctx.missingPagination.page + 1);
                    // @ts-ignore
                    [missingPagination, changeMissingPage,];
                } },
            disabled: (!__VLS_ctx.missingPagination.hasNextPage || __VLS_ctx.loading),
            ...{ class: "pagination-btn" },
        });
        /** @type {__VLS_StyleScopedClasses['pagination-btn']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
        ...
        (__VLS_ctx.missingPagination.page);
        (__VLS_ctx.missingPagination.totalPages);
        (__VLS_ctx.missingPagination.total);
    }
    else if (__VLS_ctx.missingPagination.total > 0) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
            ...{ class: "pagination-info-simple" },
        });
        /** @type {__VLS_StyleScopedClasses['pagination-info-simple']} */ ;
        (__VLS_ctx.paginatedMissing.length);
        (__VLS_ctx.missingPagination.total);
    }
}
// @ts-ignore
[loading, missingPagination, missingPagination, missingPagination, missingPagination, missingPagination, missingPagination, paginatedMissing,];
