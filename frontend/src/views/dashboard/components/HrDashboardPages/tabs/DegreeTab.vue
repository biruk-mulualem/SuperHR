    ...
    <div v-if="!loading" class="table-container">
      <div class="table-header">
        ...
        <div class="table-header-actions">
          <span class="table-stats">{{ pagination.total }} total employees</span>
        </div>
      </div>
          ...
          <tbody>
            ...
            <tr v-if="paginatedEmployees.length === 0">
              <td colspan="7" class="empty-state">
                {{ searchQuery ? 'No employees found matching your search' : '✅ All employees have submitted degrees!' }}
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <div v-else-if="pagination.total > 0" class="pagination-info-simple">
        Showing {{ paginatedEmployees.length }} of {{ pagination.total }} employees
      </div>
    </div>
  </div>
</template>
